...
-- fonction qui recupere la liste de tuple de deplacement et retourne une liste de traits au format xml/svg
...
-- fonction qui transforme la liste de de traits en une seule chaine de caractères
decomplist:: [[Char]]->[Char]->[Char]
decomplist [] a = a
decomplist (x:xs) s = 
    s++x++decomplist xs s 

-- fonction qui ajoute l'en-tete et le pied de page au fichier pour respecter la syntaxe xml
